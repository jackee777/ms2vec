...
try:
    ...
    from ms2vec_inner import train_batch_sg, train_batch_cbow
    from ms2vec_inner import score_sentence_sg, score_sentence_cbow
    from ms2vec_inner import FAST_VERSION, MAX_WORDS_IN_BATCH
